...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='css/payement.css' />
    ...
    <div class="wrapper" id="app">
        <div class="card-form">
                    ...
                    <div class="card-item__side -front">
                        ...
                        <div class="card-item__wrapper">
                            <div class="card-item__top">
                                <img src="image/cartes/chip.png" class="card-item__chip">
            ...
            <div class="card-form__inner">
                ...
                <div class="card-input">
                    <label for="cardName" class="card-input__label">Titulaire de carte</label>
                ...
                <div class="card-form__row">
                    ...
                    <div class="card-form__col -cvv">
                        <div class="card-input">
                            <label for="cardCvv" class="card-input__label">Cryptogramme visuel</label>
                ...
                <button class="card-form__button">Soumettre</button>
            </div>
        </div>
    </div>
